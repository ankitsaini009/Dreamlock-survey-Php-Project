                    ...
                    <form action="project_details.php?project_code=<?= safeOutput($project_code) ?>" method="POST" id="projectForm">
                        ...
                        <div class="bg-white shadow-md rounded-lg p-6 mb-8">
                            ...
                            <div class="details-grid mb-4">
                                ...
                                <div>
                                    <a href="demographics.php?project_code=<?= safeOutput($project_code) ?>&status=start" target="_blank" class="text-purple-500 underline">Start Survey</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white shadow-md rounded-lg p-6 mb-8">
                            ...
                            <div class="details-grid mb-4">
                                ...
                                foreach ($filter_options as $key => $label) {
                                    ...
                                    $checked = isset($filters[$key]) ? 'checked' : '';

                                    echo "<div class='flex items-center mb-2'>
                                            <input type='checkbox' name='filters[$key]' value='1' $checked ? 'checked' : ''  class='mr-2' disabled>
                                            <span>$label</span>
                                          </div>";
                                }
                                ?>
